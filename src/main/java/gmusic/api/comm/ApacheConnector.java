...
//		HttpConnectionParams.setSoTimeout(params, socketTimeoutMillis);
    ...
    private HttpResponse execute(URI uri, HttpRequestBase request)
    ...
    @Override
    public final synchronized String dispatchGet(URI address)
    ...
    private String setupAuthentication(String response)
    ...
    @Override
    public String dispatchPost(URI address, String json)
