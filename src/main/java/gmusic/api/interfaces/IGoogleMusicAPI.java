...
public interface IGoogleMusicAPI {
    ...
    DeletedPlayList deletePlaylist(String id) throws Exception;
    Collection<File> downloadSongs(Collection<Song> songs)
                            throws MalformedURLException, ClientProtocolException, IOException, URISyntaxException, InvalidAttributesException;
    ...
    void changeSongMetaData(Song song) throws Exception;
    DeletedSongs deleteSongs(String[] songIds) throws Exception;
}
